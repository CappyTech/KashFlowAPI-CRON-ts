...
export async function startSshTunnel() {
    ...
    for (let offset = 0; offset <= 10; offset++) {
        ...
        try {
            ...
            logger.info({ local: `${serverOptions.host}:${serverOptions.port}`, remote: `${forwardOptions.dstAddr}:${forwardOptions.dstPort}` }, 'SSH tunnel established');
            return server;
        }
        catch (e) {
            lastErr = e;
