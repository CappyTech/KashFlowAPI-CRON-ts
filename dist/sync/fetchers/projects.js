...
export async function fetchProjects(page = 1, perpage = 100, params = {}) {
    const raw = await getWithRetry('/projects', { page, perpage, sortby: 'Number', order: 'Asc', ...params });
    if (page === 1) {
    ...
    return { items: items, ...meta, nextPageUrl: nextPageUrl ?? undefined, isUnpaged };
}
