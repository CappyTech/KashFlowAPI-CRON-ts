...
export function startMetricsServer() {
  ...
  <div id="legend" style="display:none;font-size:.6rem;opacity:.7;margin-top:.25rem;">* full refresh traversal</div>
      ...
      <p style="margin-top:1rem;font-size:.75rem;">Shortcuts: <a href="/metrics" target="_blank">/metrics</a> · <a href="/sync-summary" target="_blank">/sync-summary</a> · <a href="/summaries" target="_blank">/summaries</a> · <a href="/upserts" target="_blank">/upserts</a></p>
      <script>
